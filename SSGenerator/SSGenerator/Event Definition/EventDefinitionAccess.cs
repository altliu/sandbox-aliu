...
{
    class EventDefinitionAccess : EventDefintionWrapperBase
    {
        ...
        static EventDefinitionAccess()
        {
            _metadataFields.Add(_typeField);
            _metadataFields.Add(_locationField);
            _metadataFields.Add(_cardField);
            _metadataFields.Add(_userField);
            _metadataFields.Add(_descriptionField);
        }
    }
}
